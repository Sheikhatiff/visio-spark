  ...
  return (
    <div className="h-screen bg-gray-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm space-y-6 relative z-10">
        ...
        {/* Signup Form - Compact */}
        <form onSubmit={handleSignup} className="space-y-4 bg-gray-800/90 backdrop-blur-sm rounded-xl p-6 border border-gray-700 shadow-xl">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-3 py-3 pr-10 text-sm bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:bg-gray-600/50 transition-all duration-300 ${
          ...
          <div className="flex items-start space-x-2">
            <label className="flex items-start space-x-2 cursor-pointer flex-1">
              ...
              <span className="text-gray-300 text-sm leading-tight">
                I agree to the{' '}
                <button type="button" className="text-amber-400 hover:text-amber-300 hover:underline">
                  Terms of Service
                </button>{' '}
                and{' '}
                <button type="button" className="text-amber-400 hover:text-amber-300 hover:underline">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className={`w-full py-3 px-4 rounded-lg font-semibold text-white transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-amber-500/30 ${
              isLoading 
