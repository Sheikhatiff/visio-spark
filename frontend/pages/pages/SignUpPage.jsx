        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center justify-center h-full">
          ...
          <div className="hidden lg:block space-y-4 max-h-[600px] overflow-hidden">
            <div className="space-y-3">
              ...
              >
                Register in seconds — fast, secure, and built for modern
                applications.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Your account stays encrypted & safe",
                },
                {
                  icon: Sparkles,
                  title: "Instant Setup",
                  desc: "Sign up and access your dashboard immediately",
                },
                {
                  icon: Check,
                  title: "Grow Seamlessly",
                  desc: "Upgrade anytime as your usage scales",
                },
              ].map((i, index) => (
                <div
                  key={index}
